...
class KerrNewman:
	def __init__(self, modes):
		...
		self.cij_omega = jnp.stack([c_omega[i] for i in self.indices])
	...
	def get_charged_omega(self, chi, Q):
		omega = jnp_chiq_exact_factors(chi, Q, self.Y0_bij_omega, self.cij_omega)
		gamma = jnp_chiq_exact_factors(chi, Q, self.Y0_bij_gamma, self.cij_gamma)
		return omega, gamma
